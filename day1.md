...
Amazon offers services via AWS that drives a significant proportion of the internet.

We are using it in class because of its free tier and universality, but other options are available such as the recommendable www.dreamhost.com and www.hostgator.com. Google Cloud computing is a competing service as well.
